const I18n = {
    ...
    translations: {
        ko: {
            ...
            'help': '도움말',
            'etc': '기타',
            'settings_group_audio': '오디오',
            'music_volume': '음악 볼륨',
            'sfx_volume': '효과음 볼륨',
            'settings_group_gameplay_screen': '게임플레이 화면',
            ...
            'show_home_recommendations': '홈 화면 추천 비트맵',
            'use_default_fall_speed': '플레이어 기본 하강 속도 지정',
            'default_fall_speed_value': '기본 하강 속도',
            'settings_group_timing_calibration': '판정 타이밍 보정',
            ...
            // 모양 설정
            'settings_group_theme_skin': '테마 & 스킨',
            'settings_group_note_style': '노트 스타일',
            'settings_group_text_effects': '텍스트 & 이펙트',
            'settings_group_font_image': '폰트 & 이미지 스킨',
            'settings_group_preview': '미리보기',
            'position_editor_open_btn': '🖐 판정 / 콤보 / 카운트다운 위치 드래그로 편집',
            'position_editor_title': '텍스트 위치 편집',
            'position_editor_desc': '드래그해서 원하는 위치에 놓아보세요. 저장을 누르면 그 위치가 계속 적용됩니다. (설정 탭 하단의 "적용" 버튼을 눌러야 최종 저장됩니다.)',
            'position_editor_reset': '초기화',
            'position_editor_save': '저장',
            'position_editor_manual': '직접 입력 (숫자로 미세 조정)',
            'position_editor_state_desc': '화면 배치별로 #game-area 크기가 달라서, 위치는 아래 3가지를 각각 따로 저장합니다. 지금 편집할 대상을 골라주세요.',
            'position_editor_state_desktop': '데스크톱(펼침)',
            'position_editor_state_desktop_collapsed': '데스크톱(접힘)',
            'position_editor_state_mobile': '모바일',
        ...
        en: {
            ...
            'settings_group_gameplay_screen': 'Gameplay Screen',
            ...
            'show_home_recommendations': 'Show Featured Beatmap on Home',
            'use_default_fall_speed': 'Set Default Fall Speed',
            'default_fall_speed_value': 'Default Fall Speed',
            'settings_group_timing_calibration': 'Timing Calibration',
            ...
            // Appearance settings
            'settings_group_theme_skin': 'Theme & Skin',
            'settings_group_note_style': 'Note Style',
            'settings_group_text_effects': 'Text & Effects',
            'settings_group_font_image': 'Font & Image Skin',
            'settings_group_preview': 'Preview',
            'position_editor_open_btn': '🖐 Drag to Position Judgement / Combo / Countdown',
            'position_editor_title': 'Edit Text Position',
            'position_editor_desc': 'Drag each item to where you want it. Press Save to keep the position. (You still need to press "Apply" at the bottom of the tab to save permanently.)',
            'position_editor_reset': 'Reset',
            'position_editor_save': 'Save',
            'position_editor_manual': 'Manual entry (fine-tune with numbers)',
            'position_editor_state_desc': 'The #game-area size differs by layout, so position is saved separately for each of the 3 below. Choose which one to edit.',
            'position_editor_state_desktop': 'Desktop (expanded)',
            'position_editor_state_desktop_collapsed': 'Desktop (collapsed)',
            'position_editor_state_mobile': 'Mobile',
